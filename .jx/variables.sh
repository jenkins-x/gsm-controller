...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/gsm-controller/master/3'
...
export MINK_IMAGE='ghcr.io/jenkins-x/gsm-controller:0.0.60'
